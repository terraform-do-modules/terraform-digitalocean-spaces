##------------------------------------------------
## Terragrunt configuration for DigitalOcean Spaces
##
## Prerequisites:
...
##     and for the Spaces provider to manage bucket resources)
##
## The Spaces provider reads credentials from the environment:
